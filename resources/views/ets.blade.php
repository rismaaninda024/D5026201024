...
<head>
    ...
    <title>ETS PWEB D</title>
    <style>
        body{
           background-color: rgb(41, 33, 109);
...
<body>
    <div class="container">
        <form class="form border border-2 border-dark rounded px-5 py-3 my-5" onsubmit="return validation() " action="https://www.google.com/" >
            <p><b>Risma Aninda</b></p>
            <p><b>Anin</b></p>
            <p><b>5026201024</b></p>
